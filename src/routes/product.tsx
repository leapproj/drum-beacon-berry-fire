      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="rounded-xl bg-surface p-5 shadow-[var(--shadow-border)]">
            <p className="text-xs tracking-wide text-muted uppercase">Self-serve</p>
            <p className="mt-2 font-medium">You operate the tenant</p>
            <p className="mt-2 text-sm text-muted">
              Buy a season license. Draft until the whole plan is complete. Publish when ready.
            </p>
          </div>
          <div className="rounded-xl bg-surface p-5 shadow-[var(--shadow-border)]">
            <p className="text-xs tracking-wide text-muted uppercase">Co-partner</p>
            <p className="mt-2 font-medium">TukodPH operates the digital festival</p>
            <p className="mt-2 text-sm text-muted">
              30% commission on digital sponsor income only. Physical festival sponsors stay with
              the organizer.
            </p>
          </div>
        </div>
