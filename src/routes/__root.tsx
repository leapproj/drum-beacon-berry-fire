...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "theme-color", content: "#160910" },
      {
        name: "description",
        content:
          "eSAULOG DFEMS — Digital Festival Operating System for Philippine festivals. Plan, authenticate, engage, and measure.",
      },
    ],
    links: [
