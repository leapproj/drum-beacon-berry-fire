...
import { i as TopBar, n as PageHeader, r as Stat, t as Page } from "./shell-GkA-jbwc.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/hub-hwg6aBTN.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Page, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
					...
					description: ssp ? "View every festival tenant. Open Headquarters to control the platform, or open a command center as co-partner." : "Create, draft, organize, and publish your festivals. You only see desks you own.",
