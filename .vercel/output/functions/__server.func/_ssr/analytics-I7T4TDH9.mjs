...
import { m as Route$14 } from "./router-5l7utmBS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/analytics-I7T4TDH9.js
var import_jsx_runtime = require_jsx_runtime();
function AnalyticsPage() {
	const { festivalId } = Route$14.useParams();
	const { data } = useQuery({
