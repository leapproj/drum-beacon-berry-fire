...
//#region node_modules/.nitro/vite/services/ssr/assets/applications-CzPTo2tr.js
...
function AppsPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Page, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: (data?.apps ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "px-5 py-6 text-sm text-muted",
				children: "No applications yet."
			}) : (data?.apps ?? []).map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
