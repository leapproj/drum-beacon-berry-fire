...
import { l as Route$9 } from "./router-5l7utmBS.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/participants-C4NMwprp.js
var import_jsx_runtime = require_jsx_runtime();
function PeoplePage() {
	const { festivalId } = Route$9.useParams();
	const { data } = useQuery({
